...
import { APP_AUDIENCE } from '@/config/app-audience';
...
export const SignupScreen: React.FC<SignupScreenProps> = ({ navigation }) => {
    ...
    const handleSocialSignup = useCallback(
        async (credential: any, method: 'google' | 'apple') => {
            ...
            try {
                ...
                await loginWithCredential(credential, APP_AUDIENCE);
    ...
    const handleSignup = async () => {
        ...
        try {
            ...
            await signup(email, password, APP_AUDIENCE, referralCode ?? undefined);
        ...
        <SafeAreaView style={styles.container}>
            ...
            >
                <View style={styles.content}>
                    <ResponsiveContent style={styles.responsiveOuter} innerStyle={styles.form}>
                        <AppText style={styles.title}>Clean City Driver</AppText>
                        <AppText style={styles.subtitle}>
                            Earn money collecting waste in your city
                        </AppText>
                        ...
                        {/* Email-only signup for now. Restore Google/Apple when ready.
