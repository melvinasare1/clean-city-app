    ...
    <ScreenContainer style={styles.container}>
      <View style={styles.card}>
        ...
        <AppText style={styles.body}>
          One-time pickups of GHS 100 or less must use Mobile Money. Above GHS
          100 you can pay with Mobile Money or card. Subscriptions can use
          Mobile Money or card. Card payments are charged in your selected
          currency after a live conversion from GHS, plus a 2% card payment
          surcharge.
        </AppText>
      </View>
      <View style={styles.card}>
